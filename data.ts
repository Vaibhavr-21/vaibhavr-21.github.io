import { Job, EducationItem, Certification, PersonalInfo } from './types';
...
export const skillsList = [
  ...
  "BADI / User Exits / Customer Exits",
  "Enhancement Framework",
  "ALE / EDI / IDOCs",
  "BAPIs",
  "Performance Tuning (SAT, ST05)",
  "Adobe Forms (Interactive & Static)",
  "Smart Forms",
  "SAP Modules: MM, SD, FI, PP, QM, PM",
...
export const experienceData: Job[] = [
  ...
  },
  {
    ...
    projects: [
      {
        name: "S4 HANA Implementation & AMS",
        responsibilities: [
  ...
  },
  {
    ...
    projects: [
      {
        name: "Pharma Company (Back to Basics)",
